...
module.exports = {
    ...
    */
   key: "definition_manager.migrate-index-delete",
    ...
    *        api_sails/api/controllers/definition_manager/migrate-index-delete.
    * @param {fn} cb
   ...
   fn: function handler(req, cb) {
      ...
      ABBootstrap.init(req)
         .then(async (AB) => { // eslint-disable-line
            ...
            try {
               await index.migrateDrop(req);
               cb(null, { status: "success" });
            } catch (e) {
               req.notify.developer(e, {
                  context:
                     "Service:definition_manager.migrate-index-delete: Error removing Index",
                  id,
                  obj: object.toObj(),
                  index: index.toObj(),
               });
         ...
         .catch((err) => {
            req.notify.developer(err, {
               context:
                  "Service:definition_manager.migrate-index-delete: Error initializing ABFactory",
            });
            cb(err);
         });
   },
