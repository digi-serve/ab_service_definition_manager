...
module.exports = {
    ...
    */
   key: "definition_manager.migrate-field-down",
    ...
    *        api_sails/api/controllers/definition_manager/migrate-field-down.
    * @param {fn} cb
   ...
   fn: function handler(req, cb) {
      ...
      ABBootstrap.init(req)
         .then(async (AB) => { // eslint-disable-line
            ...
            try {
               await field.migrateDrop(req);
               cb(null, { status: "success" });
            } catch (e) {
               req.notify.developer(e, {
                  context:
                     "Service:definition_manager.migrate-field-drop: Error removing field",
                  id,
                  obj: object.toObj(),
                  field: field.toObj(),
               });
         ...
         .catch((err) => {
            req.notify.developer(err, {
               context:
                  "Service:definition_manager.migrate-field-down: Error initializing ABFactory",
            });
            cb(err);
         });
   },
