...
module.exports = {
    ...
    */
   key: "definition_manager.migrate-index-create",
    ...
    *        api_sails/api/controllers/definition_manager/migrate-index-create.
    * @param {fn} cb
   ...
   fn: function handler(req, cb) {
      ...
      ABBootstrap.init(req)
         .then(async (AB) => { // eslint-disable-line
            ...
            try {
               await index.migrateCreate(req);
               cb(null, { status: "success" });
            } catch (e) {
               req.notify.developer(e, {
                  context:
                     "Service:definition_manager.migrate-index-create: Error migrating Index",
                  id,
                  obj: object.toObj(),
                  index: index.toObj(),
               });
         ...
         .catch((err) => {
            req.notify.developer(err, {
               context:
                  "Service:definition_manager.migrate-index-create: Error initializing ABFactory",
            });
            cb(err);
         });
   },
