...
module.exports = {
    ...
    */
   key: "definition_manager.migrate-field-update",
    ...
    *        api_sails/api/controllers/definition_manager/migrate-field-update.
    * @param {fn} cb
   ...
   fn: function handler(req, cb) {
      ...
      ABBootstrap.init(req)
         .then(async (AB) => { // eslint-disable-line
            ...
            try {
               await field.migrateUpdate(req);
               cb(null, { status: "success" });
            } catch (e) {
               req.notify.developer(e, {
                  context:
                     "Service:definition_manager.migrate-field-update: Error updating field",
                  id,
                  obj: object.toObj(),
                  field: field.toObj(),
               });
         ...
         .catch((err) => {
            req.notify.developer(err, {
               context:
                  "Service:definition_manager.migrate-field-update: Error initializing ABFactory",
            });
            cb(err);
         });
   },
